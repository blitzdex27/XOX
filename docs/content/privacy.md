# Privacy Policy for XOX by Dekideks

**Effective date:** March 4, 2026

This Privacy Policy explains how XOX by Dekideks ("XOX", "we", "us", or "our") handles information when you use the XOX iOS app.

## 1. Scope

This policy applies to the XOX iOS app distributed through the Apple App Store.

## 2. Data processing in the current app
...
## 5. Children and audience

XOX is currently offered for a **general audience** and is **not designated in the App Store Kids Category**.

## 6. Future changes (including ads)
...
App availability by country or region is managed in App Store Connect and may be updated over time.

## 8. Changes to this policy

We may revise this policy to reflect product, legal, or operational changes. The "Effective date" at the top will be updated when changes are published.
